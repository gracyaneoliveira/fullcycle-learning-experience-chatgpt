...
import (
	...
	"github.com/gracyaneoliveira/fclx/chatservice/internal/domain/entity"
	"github.com/gracyaneoliveira/fclx/chatservice/internal/domain/gateway"
...
func NewChatCompletionUseCase(chatGateway gateway.ChatGateway, openClient *openai.Client, stream chan ChatCompletionOutputDTO) *ChatCompletionUseCase {
	return &ChatCompletionUseCase{
		ChatGateway:  chatGateway,
		OpenAiClient: openClient,
		Stream:       stream,
	}
}
